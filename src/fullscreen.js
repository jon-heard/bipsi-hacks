...
🖥️
@file fullscreen
@summary Add a ui button and hotkey to the editor to toggle fullscreen while running the game.
@license MIT
@author Violgamba (Jon Heard)

@description
Add a ui button and hotkey to the editor to toggle fullscreen mode while running the game.
